...
%>
                                                  <!-- THIS IS INCHARGE LOGIN HOME PAGE -->
		  ...
		  $.post("../InchargeLoginVerify",{
	    	 ...
	    	 //alert(data);
	          ...
	          //get a acc_open status
	        	  ...
	        	  //alert("account in");
	        	  window.location.href="InchargePortal.jsp";
	          }else if(data=='2'){
	        	  document.getElementById("validate_err1").style.display="none";  
	        	  document.getElementById("validate_err2").style.display="none"; 
...
<div class="login-form">    
    <form method="post">
		...
		<p class="validate_err alert alert-danger" id="validate_err3" style="display:none;margin-top:15px;margin-bottom:5px;">Your Account opening request has rejected because of invalid details,So you are not able to login!!!</p>
		
		<br>
		<h4 class="modal-title" style="margin-bottom:5px;background-color:black;color:white">Incharge Login</h4>
		<br>
        ...
        <div class="form-group small clearfix">
            <a href="InchargeForgotPass.jsp" class="forgot-link">Forgot Password?</a>
        </div>
    ...
    <div class="text-center small">Don't have an account? <a href="InchargeRegistration.jsp" style="cursor:pointer;">Sign up</a></div>
