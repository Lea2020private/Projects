...
//delete all cookies
Cookie cookie=new Cookie("login_key","");
cookie.setPath(request.getContextPath());
cookie.setMaxAge(0);
response.addCookie(cookie);

Cookie cookie1=new Cookie("forgot_password_key","");
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
 ...
 if(errors==0){
      ...
      if(data=="changed_successfully"){
    	 ...
    	 window.location.href="InchargeLogin.jsp";
      }else{
    	  location.reload();
      }
 ...
 function CheckAccExists(){
 	...
 	if(mobno==''){
 		document.getElementById("mobnoerr").style.display="block";
 		errors++;
 	}else{
 		document.getElementById("mobnoerr").style.display="none";
 	}
...
<div class="login-form">    
    <form method="post">
	    ...
	    <p class="validate_error alert alert-danger" id="validate_err4" style="display:none;margin-top:15px;margin-bottom:5px;">Your Account has Rejected because of Invalid data,Please try again with valid data!!!</p>
	     <br>
	    <h4 class="modal-title" style="margin-bottom:5px;background-color:black;color:white">Incharge</h4>
		<br>
	    <br>
        ...
        <div class="form-group">
         <p>&nbsp; MOBILE NUMBER</p>
            ...
            <p style="color:red;display:none" id="mobnoerr">*required </p>
        </div>
          <div class="form-group">
