...
if(encryptedApplicationId==""){
	response.sendRedirect("../index.jsp");
	 ...
	 applicationId=obj.decryption(encryptedApplicationId);
}
%>
<body>
...
<div class="login-form">    
    <form method="post">
    	...
    	<h5>Your Account opening User id is <span style="font-size:17px;text-decoration:underline"> <%=applicationId %> </span>,Please Notedown for Future reference</h5>
    	<h5>Trace your Application status <a href="StudAcc_StatusTrack.jsp">here</a></h5>
        <h5>Login in to Your Account <a href="StudentLogin.jsp"> here </a></h5>
