...
try{
	...
	if(rs.next()){
	 ...
	 regno=rs.getString("register_number");
...
<div class="login-form">    
    <form method="post">
     <h4 class="modal-title" style="margin-bottom:5px;background-color:black;color:white">STUDENT PROFILE</h4>
		<br>
  ...
  <tr>
    <td style="font-size:20px;font-style:italic;text-decoration:underline">REGISTER NUMBER</td>
   <td style="font-size:18px;color:red"> <%=regno %></td>
  </tr>
  <tr>
    <td style="font-size:20px;font-style:italic;text-decoration:underline">ROLE</td>
   <td style="font-size:18px;color:red"> <%=role.toUpperCase() +" COORDINATOR" %> </td>
  </tr>
    <tr>
    <td style="font-size:20px;font-style:italic;text-decoration:underline">YEAR</td>
    <td style="font-size:18px;color:red"> <%=year %></td>
  </tr>
    <tr>
  ...
  <tr>
   ...
   <td style="font-size:18px;color:red"><img src="tt.jpg" alt="IDCARD" width="100" height="100"></td>
           ...
           <br>
      <div class="buttons">
        <a href="../StudentLogout" type="button" id="btn" style="" class="btn btn-primary">LOGOUT</a>
        <a href="StudentPermissionRequest.jsp" type="button" id="btn" style="" onclick="" class="btn btn-primary" > REQUEST PERMISSION</a>      
        <a href="StudentMyPermissions.jsp" type="button" id="btn" style="" onclick="" class="btn btn-primary"> MY PERMISSIONS </a> 
      </div>       
    </form>			
</div>
</div>
