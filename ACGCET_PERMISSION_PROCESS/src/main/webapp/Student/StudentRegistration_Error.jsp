...
<div class="login-form" >   
    ...
    <form action="../StudentRegistration_back" method="post" onsubmit="return ValidateForm()">
    		...
    		<p class="validate_error alert alert-danger" id="validate_error" style="display:one;margin-top:15px;margin-bottom:5px;">USERNAME/REGISTER NUMBER/EMAIL/MOBILE NUMBER is Already found in our database try with new one !!!</p>
   <br>
   <h4 class="modal-title" style="margin-bottom:5px;background-color:black;color:white">Student Registration</h4>
        ...
        <div class="form-group">
         ...
         <p>&nbsp; USER NAME</p>
            <input type="text" class="form-control" name="uname" id="uname" placeholder="Enter your username" required="required">
             <p style="color:red;display:none" id="unameerr">*USERNAME ALREADY TAKEN </p>
        </div>
        <div class="form-group">
         <p>&nbsp; REGISTER NUMBER</p>
            <input type="text" class="form-control" name="regno" id="regno" placeholder="Enter your regno" required="required">
            <p style="color:red;display:none" id="regnoerr">*REGNO ALREADY FOUND</p>
        </div>
       ...
       <div class="form-group">
         ...
         <p>&nbsp; MOBILE NUMBER</p>
            ...
            <p style="color:red;display:none" id="mobnoerr">*MOBILE NUMBER ALREADY FOUND,USE ANOTHER </p>
        </div>
        
         <div class="form-group">
         <p>&nbsp; EMAIL</p>
           <input type="email" class="form-control" name="email" id="email" placeholder="Enter your mail id" required="required">
           <p style="color:red;display:none" id="emailerr">*EMAIL IS ALREADY FOUND,USE ANOTHER </p>
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                   ...
                   <input type="file" class="form-control"  accept="image/*" name="idcard" id="idcard" required>
            </div> 
