 ...
 */
public class InchargeRegistration_back extends HttpServlet {
...
//	   System.out.print(request.getParameter("name"));  //for debugging
	   ...
	   InchargeRegistrationDAO obj=new  InchargeRegistrationDAO();
	   obj.setName(name);
	   ...
	   if(insertionStatus!=0) {
		   String encryptUser_id=obj.GetUserId(uname);
     	  ...
     	  response.sendRedirect("Incharge/AfterInchargeRegistration.jsp");
	       
	   }else {
		   System.out.println("SQLException: " + insertionStatus);
           response.sendRedirect("Incharge/InchargeRegistration_Error.jsp");
	   }
	}
}
