...
function cal(){
  ...
  //document.getElementById("gpa").style.display = "block";
    ...
    xmlhttp.open("GET","http://acgcet-cgpa.great-site.net/sgpa.php?q="+arr, true);
    xmlhttp.send();
    }
  /* 
function hide(){
...
<i class="fa fa-hand-o-right" style="font-size:30px;color:white"></i><a href="http://acgcet-cgpa.great-site.net/Homepage.php" class="btn btn-primary btn-sm">GO BACK</a><i class="fa fa-hand-o-left" style="font-size:30px"></i>
</div>
</div>
<!-- Modal -->
<div class="modal fade" id="myModalHorizontal" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" method="post" action="pdf.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control"
                            id="" placeholder="" name="regno" required/>
                    </div>
                  </div>
                  <div class="form-group">
  ...
  <footer>
    ...
    <p>Copyright by <a class="a2" href="www.exampl.com">www.exampl.com</a></p>
