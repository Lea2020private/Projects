...
<div class="btn-group" data-toggle="buttons">
  <label class="btn btn-cyan btn-rounded form-check-label"  onclick="showdept()" style="background-color:green;border-radius:15px;color:white; font-size:17px;">
    <input class="form-check-input" type="radio" name='reg' value="2015A"  >2015A
  </label>
  <br>
  <br>
  <label class="btn btn-cyan btn-rounded form-check-label"  onclick="showdept()" style="background-color:green;border-radius:15px;padding-left:22px; color:white; font-size:17px">
...
<div class="btn-group" data-toggle="buttons">
  <label class="btn btn-cyan btn-rounded form-check-label"  onclick="showsem()" style="background-color:green;border-radius:15px;padding-left:14px;color:white; font-size:17px;">
    <input class="form-check-input" type="radio" name='dept' value="CIVIL">CIVIL
  </label>
  <br><br>
  <label class="btn btn-cyan btn-rounded form-check-label"    onclick="showsem()" style="background-color:green;border-radius:15px;padding-left:9px;color:white; font-size:17px;">
    <input class="form-check-input" type="radio" name='dept' value="MECH">MECH
  </label>
  <br><br>
  <label class="btn btn-cyan btn-rounded form-check-label"  onclick="showsem()"   style="background-color:green;border-radius:15px;padding-left:22px;color:white; font-size:17px;">
...
<div class="btn-group" data-toggle="buttons">
  <label class="btn btn-cyan btn-rounded form-check-label"   onclick="showsub()" style="background-color:green;border-radius:15px;padding-left:22px;color:white; font-size:17px;">
  ...
  <label class="btn btn-cyan btn-rounded form-check-label"   onclick="showft()"  style="background-color:green;border-radius:15px;padding-left:22px; color:white; font-size:17px">
...
<div class="btn-group" data-toggle="buttons">
  <label class="btn btn-cyan btn-rounded form-check-label" onclick="showsub()" style="background-color:green;border-radius:15px;padding-left:15px;color:white; font-size:17px;">
...
<input type="submit" value="&#8250;&#8250;&#8250;&#8250;&#8250;" class="btn btn-primary" id="arrow">
 </div>
   </form> 
  <footer>
     <div class="footer">

    <p>Copyright by <a class="a2" href="#">www.exampl.com</a></p>
