...
<head>
  ...
  <script type="text/javascript" src="addd.js"></script>  
...
<div class="col-sm-3" >
  ...
  <div id="Add1" style="display:none">     
        ...
        <br>
        <button type="button" style="margin-left:145px;"class="btn btn-success" onclick="Addmobtno()">ADD</button>
        </div>
        </div> 
</div>
...
<div id="Changepass1" style="display:none">
  ...
  <!-- <p style="color:black;margin-left:55px"><?php echo $row['time1'];?></p> --->
  </h5>
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div id="Add2" style="display:none">
     <div class="col-sm-3">
        <div>
        <input type="text" class="form-control tno"  placeholder="Enter Tracking No.." name="tnodeskadd">
        <br>
        <button type="button" style="margin-left:110px;"class="btn btn-success" onclick="Adddesktno()">ADD</button>
        </div>
    </div>  
    </div>
...
<div class="progres_desk1">
  ...
  <div id="trackdesk2" style="display:none">
    ...
    <div class="col-sm-9" style=" visibility: hidden;">
    <input type="text" class="form-control tno" id="" >
    </div>  
    <div class="col-sm-9" style=" visibility: hidden;">
    <input type="text" class="form-control tno" id="" placeholder="Enter Tracking No..">
    </div>  
